...
const src = ref(
  `/api/method/drive.api.files.get_file_content_preview?entity_name=${props.previewEntity.name}`
)
...
watch(
  ...
  (newValue) => {
    loading.value = true
    src.value = `/api/method/drive.api.files.get_file_content_preview?entity_name=${newValue.name}`
